...
export const Register = () => {
  ...
  /* However, once we wrap the SkillList component in memo (which is a higher-order function, meaning it accepts a function as an argument), it no longer re-renders unnecessarily when our parent component does. */
